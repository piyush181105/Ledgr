...
import { Edit, Eye, EyeOff, Lock, User, X } from 'lucide-react';
    ...
    <div className={profileStyles.container}>
        ...
        <div className={profileStyles.content}>
          <div className={profileStyles.grid}>
            ...
            <div className={profileStyles.card}>
              ...
              <button onClick={handleLogout} className={`${profileStyles.buttonPrimary}mt-8 w-full hover:opacity-90 transition-opacity`} disabled={loading}>
      ...
      >
        <div className={profileStyles.modalContent}>
          ...
          <form onSubmit={handlePasswordSubmit} className="space-y-4 lg:-mx-15">
            <PasswordInput
              name="current"
