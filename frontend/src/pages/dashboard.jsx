...
import {
  ...
  Plus,
  ShoppingCart,
  TrendingDown, // Make sure this is here
  TrendingUp,   // Make sure this is here
  Wallet,
  BarChart3,
} from 'lucide-react';
...
const Dashboard = () => {
  // Replace your context line with this:
  const {
    transactions = [],
    user = {},
    refreshTransactions = () => { },
  ...
  <div style={{ height: '300px', width: '100%' }}>
    <ResponsiveContainer width="100%" height="100%">
      <BarChart
        ...
        layout="vertical" // Makes it look modern and easy to read
