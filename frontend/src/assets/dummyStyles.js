...
export const dashboardStyles = {
  ...
  // Header styles
  headerContainer: "bg-gradient-to-r from-indigo-50 to-indigo-100 backdrop-blur-lg rounded-3xl p-6 mb-8 shadow-lg border border-white/30",
  headerContent: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8",
  headerTitle: "text-3xl md:text-4xl font-bold bg-gradient-to-r from-indigo-600 to-indigo-800 bg-clip-text text-transparent",
  headerSubtitle: "text-gray-600 mt-2",

  // Button styles
  addButton: "flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-3 rounded-xl transition-all shadow hover:shadow-md font-medium",
  ...
  balanceBadge: "bg-indigo-100 text-indigo-700 px-2 py-1 rounded-lg text-xs",
  expenseBadge: "bg-red-100 text-red-700 px-1 py-1 rounded-lg text-xs",
  ...
  pieChartContainer: "block bg-white lg:-mx-5.5 md:-mx-4 lg:p-1 xl:-mx-3 rounded-xl p-5 shadow-sm border border-gray-100 relative overflow-hidden mb-8",
  ...
  pieChartHeight: "h-[350px] w-full block",
  ...
  expenseCountBadge: "text-sm bg-red-100 text-red-800 px-2 mx-2 md:mx-2 md:mt-2 py-1 rounded-full",
  ...
  expenseTransactionItem: "flex items-center justify-between mx-1 p-3 lg:p-3 md:p-4 md:mx-2 bg-red-50 rounded-lg",

  // Transaction icon container
  incomeIconContainer: "p-2 bg-green-100 rounded-lg",
  expenseIconContainer: "p-2 bg-red-100 rounded-lg",
  ...
  expenseAmount: "font-bold text-red-600",
  ...
  arrowDownIconContainer: "p-2 bg-red-100 rounded-lg",
  piggyBankIconContainer: "p-2 bg-yellow-100 rounded-lg",
};
...
export const trendStyles = {
  ...
  positiveRate: "bg-green-100 text-green-700",
...
export const incomeStyles = {
  ...
  addButton: "flex items-center gap-2 bg-gradient-to-r from-green-600 to-green-600 hover:from-green-700 hover:to-emerald-700 text-white px-3 py-2 md:px-4 md:py-3 rounded-lg md:rounded-xl transition-all shadow-md hover:shadow-lg font-medium text-sm md:text-base",
  ...
  borderPink: "border-l-4 border-pink-500",
...
export const expensePageStyles = {
  ...
  addButton: "flex items-center gap-2 bg-gradient-to-r from-red-500 to-amber-500 hover:from-red-600 hover:to-amber-600 text-white px-4 py-3 rounded-xl transition-all shadow-md hover:shadow-lg font-medium",
  ...
  viewAllButton: "mt-4 w-full text-center py-3 text-red-600 font-medium hover:bg-amber-50 rounded-xl transition-colors flex items-center justify-center gap-2",
  emptyState: "text-center py-8",
  emptyStateIcon: "w-16 h-16 mx-auto mb-4 rounded-full bg-red-50 flex items-center justify-center",
  emptyStateText: "text-gray-600 font-medium",
  emptyStateSubtext: "text-sm text-gray-500 mt-2",

  // Icons
  iconRed: "p-2 bg-red-100 rounded-lg",
  ...
  // Borders
  borderRed: "border-l-4 border-red-500",
...
export const profileStyles = {
  ...
  // Header styles
  header: "bg-gradient-to-r from-indigo-500 to-indigo-600 p-8 text-center",
  ...
  // Card styles
  card: "bg-gray-900 p-6 rounded-2xl border border-gray-800 shadow-sm hover:shadow-md transition-all duration-300",
  cardTitle: "text-sm font-medium text-gray-400",
  cardValue: "text-3xl font-bold text-white mt-2",
  ...
  // Button sty
  buttonPrimary: "flex-1 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white py-2.5 rounded-xl font-medium shadow-md",
...
export const modalStyles = {
  ...
  colorClasses: {
    ...
    red: {
      button: "bg-gradient-to-r from-red-500 to-amber-500 hover:from-red-600 hover:to-amber-600",
      ring: "focus:ring-red-500",
      typeButtonSelected: "bg-red-500",
    },
  },
};
...
export const loginStyles = {
  ...
  sidebar: "hidden lg:flex flex-col w-1/2 bg-gradient-to-br from-indigo-900 to-indigo-700 p-12 text-white justify-between",
  sidebarTitle: "text-5xl font-bold leading-tight mb-6",
  sidebarSubtitle: "text-xl text-indigo-200",
  
  // Right Side: Form Container
  formWrapper: "w-full lg:w-1/2 flex items-center justify-center p-8",
  cardContainer: "w-full max-w-md", // No longer needs 'shadow-xl' if it's on a plain white bg
  
  // Update these to match the image
  headerTitle: "text-3xl font-bold text-gray-900 mb-2",
  headerSubtitle: "text-gray-500 mb-8",
  
  // Inputs (make them look like the image: light gray bg, subtle border)
  input: "w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none",
  
  // Button
  button: "w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 rounded-lg font-medium transition-all",
  
  // Remove the old header/avatar classes if they don't fit the new design
...
{/*export const loginStyles = {
  // Page container
  pageContainer: "min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-indigo-50 to-indigo-50",

  // Card container
  cardContainer: "w-full max-auto max-w-md bg-white rounded-3xl shadow-xl overflow-hidden",

  // Header styles
  header: "bg-gradient-to-r from-indigo-500 to-indigo-600 p-6 text-center",
  ...
  // Form elements
  label: "left-3 block text-sm font-medium text-gray-700 mb-2",
  inputContainer: "relative w-full px-4", // Added px-2 for a small side buffer
  input: "w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all",
  inputIcon: "absolute inset-y-0 left-4 pl-3 flex items-center pointer-events-none text-gray-400",
  ...
  // Checkbox
  checkboxContainer: "flex items-center gap-2 mb-6 px-6",
  checkbox: "w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500",
  checkboxLabel: "text-sm text-gray-600 cursor-pointer select-none",

  // Button
  button: " w-full py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl shadow-lg transition-all active:scale-[0.98]",
  buttonDisabled: "opacity-80 cursor-not-allowed",

  // Sign up link
  signUpContainer: "mt-6 pb-4 text-center",
  signUpText: "text-gray-600",
  signUpLink: "text-[#00966d] font-bold hover:underline ml-1",
...
export const navbarStyles = {
  ...
  userAvatar: "w-9 h-9 flex items-center justify-center rounded-full bg-gradient-to-br from-indigo-600 to-indigo-500 text-white font-bold text-lg",
  ...
  // UPDATED FOR YOUTUBE LOOK
  dropdownMenu: "absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-2xl border border-gray-100 py-2 z-[100] overflow-hidden",
  dropdownHeader: "px-4 py-3 border-b border-gray-100 mb-1",
  dropdownAvatar: "w-10 h-10 rounded-full bg-gradient-to-br from-indigo-600 to-indigo-500 flex items-center justify-center text-white font-bold text-lg",
  dropdownName: "text-sm font-semibold text-gray-800",
  dropdownEmail: "text-xs text-gray-500",

  menuItemContainer: "p-1.5",
  menuItem: "flex items-center gap-3 w-full px-4 py-3 text-left hover:bg-gray-50 text-sm text-gray-700 rounded-lg transition-colors",
  menuItemBorder: "p-1.5 border-t border-gray-100 mt-1",
  logoutButton: "flex items-center gap-3 w-full px-4 py-3 text-sm hover:bg-red-50 text-red-600 rounded-lg transition-colors",
};
...
export const signupStyles = {
  ...
  pageContainer: "min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-indigo-50 to-emerald-50",
  ...
  header: "bg-gradient-to-r from-indigo-500 to-emerald-600 p-6 text-center relative",
  avatar: "w-20 h-20 mx-auto rounded-full bg-white/20 flex items-center justify-center mb-4",
  headerTitle: "text-2xl font-bold text-white",
  headerSubtitle: "text-indigo-100 mt-2",
  ...
  button: "w-full bg-gradient-to-r from-indigo-500 to-emerald-600 text-white py-3 rounded-xl font-medium shadow-md hover:shadow-lg transition-all flex items-center justify-center",
  buttonDisabled: "opacity-80 cursor-not-allowed",
...
export const sidebarStyles = {
  ...
  userInitials: {
    base: "w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-400 to-indigo-500 flex items-center justify-center text-white font-bold text-xl"
  },
  ...
  activeIndicator: "absolute right-4 w-2 h-2 bg--400 rounded-full animate-ping",
  ...
  // Mobile menu button
  mobileMenuButton: "lg:hidden fixed bottom-6 right-6 z-50 w-14 h-14 bg-gradient-to-br from-indigo-500 to-indigo-600 text-white rounded-full flex items-center justify-center shadow-xl"
};
...
export const styles = {
  ...
  // Stat Card Styles
  statCards: {
    grid: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8",
    card: "bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300",
    cardHeader: "flex justify-between items-start mb-4",
    cardTitle: "text-sm  font -medium text-gray-600",
    cardValue: "text-3xl font-bold text-gray-900 mt-2",
    iconContainer: (color) => `p-3 rounded-xl bg-${color}-50 text-${color}-600`,
    icon: (color) => `w-6 h-6 text-${color}-600`,
    cardFooter: "text-xs text-gray-400 mt-2 font-medium",
  },
  ...
  transactions: {
    ...
    dataStackingInfo: "flex items-center gap-2 text-xs text-gray-500 mb-4 bg-indigo-50 p-2 rounded-lg",
    dataStackingIcon: "w-4 h-4 text-indigo-500",
    ...
    iconWrapper: (type) => type === 'income' ? 'bg-indigo-100 text-indigo-600' : 'bg-red-100 text-red-600',
    icon: "w-4 h-4",
    details: "min-w-0",
    description: "font-medium text-gray-800 truncate max-w-[120px]",
    meta: "text-xs text-gray-500 mt-1",
    amount: (type) => `font-semibold ${type === 'income' ? 'text-indigo-600' : 'text-red-600'}`,
    emptyState: "text-center py-8",
    emptyIconContainer: "w-16 h-16 mx-auto mb-4 rounded-full bg-indigo-100 flex items-center justify-center",
    emptyIcon: "w-8 h-8 text-indigo-500",
    emptyText: "text-gray-600 font-medium",
    viewAllContainer: "pt-4 border-t border-gray-100",
    viewAllButton: "w-full flex items-center justify-center gap-2 py-3 text-indigo-600 font-medium hover:bg-indigo-50 rounded-xl transition-colors",
  },
  ...
  categories: {
    ...
    titleIcon: "w-6 h-6 text-indigo-600",
    list: "space-y-4",
    ...
    summaryIncomeCard: "bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl p-4",
    summaryExpenseCard: "bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-4",
  ...
  colors: {
    transaction: {
      text: (type) => type === 'income' ? 'text-indigo-600' : 'text-red-600',
      bg: (type) => type === 'income' ? 'bg-indigo-100 text-indigo-600' : 'bg-red-100 text-red-600',
    },
    expenseChange: (change) => change > 0 ? 'text-red-600' : 'text-green-600',
  },
};
