...
export const loginStyles = {
  ...
  input: "w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 outline-none transition-all",
  ...
  // Button
  button: " w-full py-3.5 bg-[#00966d] hover:bg-[#007a58] text-white font-semibold rounded-xl shadow-lg transition-all active:scale-[0.98]",
